...
.discount {
  ...
  <body dir="rtl" style="height: 100%; margin: 0; -webkit-text-size-adjust: none; font-family: 'Tajawal', Helvetica, Arial, sans-serif; background-color: #F2F4F6; color: #51545E; width: 100%;">
    <span class="preheader" style="visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; display: none;">لقد تم تغيير كلمة المرور الخاصة</span>
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: 'Tajawal', Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        ...
                        <p style="margin: .4em 0 1.1875em; font-size: 16px; line-height: 1.625; color: #51545E;">لقد تم تغيير كلمة المرور الخاصة بك، لتسجيل الدخول قم بالضغط على الزر التالي:</p>
                        <!-- Action -->
