                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: 'Tajawal', Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        ...
                        <p style="margin: .4em 0 1.1875em; font-size: 16px; line-height: 1.625; color: #51545E;">رجاء قم بارجاع الكتاب "{{$book_name}}" في أقرب وقت لمكتبة كلية التقنية الصناعية مصراتة، وإلا ستضطر لدفع غرامة تأخير.</p>
                      </div>
                    </td>
                  </tr>
                </table>
