...
{{-- <aside id="side-overlay" class="font-size-sm">
    ...
    <div class="content-header border-bottom">
        ...
        <!-- User Info -->
        <div class="mr-2">
            <a class="text-dark font-w600 font-size-sm" href="javascript:void(0)">محمود المنتصر</a>
        </div>
        <!-- END User Info -->

        <!-- Close Side Overlay -->
        <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
        <a class="mr-auto btn btn-sm btn-alt-danger" href="javascript:void(0)" data-toggle="layout"
    ...
    <header id="page-header">
        ...
        <div class="content-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- Layout API, functionality initialized in Template._uiApiLayout()-->
            {{-- <button type="button"
                class="btn btn-sm btn-dual mr-2 d-none d-lg-inline-block" data-toggle="layout"
            ...
            <div class="row font-size-sm">
                <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                    برمجة وتصميم <i class="fa fa-heart text-danger"></i> <a class="font-w600"
                                                                            href="https://fb.me/MahmoudAlmontasser"
                                                                            target="_blank">محمود المنتصر</a>
                </div>
