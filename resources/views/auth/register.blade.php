                            ...
                            <form class="js-validation-signin" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="py-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg form-control-alt" id="name"
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg form-control-alt"
                                            id="id_number" name="id_number" placeholder="رقم القيد أو الرقم الوظيفي"
                                            value="{{ old('id_number') }}">
                                        @error('id_number')
                                            <div style="color: red">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg form-control-alt"
                                            id="position" name="position" placeholder="الصفة" value="{{ old('position') }}">
                                        @error('position')
                                            <div style="color: red">
                                                {{ $message }}
                                            </div>
