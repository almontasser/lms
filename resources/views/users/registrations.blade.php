                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('users-registration-actions', ['user' => $user]) }}" method="POST">
                                @csrf
                                <div class="btn-group">
                                    <button type="submit" class="btn btn-sm btn-alt-primary js-tooltip-enabled"
                                            data-toggle="tooltip" title="" data-original-title="الموافقة" name="action"
                                            value="accept">
                                        <i class="fa fa-fw fa-check"></i>
                                    </button>
                                    <button type="submit" class="btn btn-sm btn-alt-primary js-tooltip-enabled"
                                            data-toggle="tooltip" title="" data-original-title="رفض" name="action"
                                            value="reject">
